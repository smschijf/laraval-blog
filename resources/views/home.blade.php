        ...
        <main class="max-w-6xl mx-auto mt-6 lg:mt-20 space-y-6">
            ...
            <div class="lg:grid lg:grid-cols-2">
                ...
                <article
                    ...
                    <div class="py-6 px-5">
                        <div>
                            <img src="./assets/img/illustration-2.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
            ...
            <div class="lg:grid lg:grid-cols-3">
                <article
                    ...
                    <div class="py-6 px-5">
                        <div>
                            <img src="./assets/img/illustration-3.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
                ...
                <article
                    ...
                    <div class="py-6 px-5">
                        <div>
                            <img src="./assets/img/illustration-4.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
                ...
                <article
                    ...
                    <div class="py-6 px-5">
                        <div>
                            <img src="./assets/img/illustration-5.png" alt="Blog Post illustration" class="rounded-xl">
                        </div>
